...
\employer{\textbf{Instructor}}
\title{\textsc{Probabilistic Programming for}}
\dates{August 2016}
\location{Portland, OR}
\begin{position}
\textsc{Advanced Machine Learning}\\
Designing and presenting curriculum for a summer school tutorial funded by the DARPA program of the same name.
\end{position}
...
\\ \\
\textbf{Conference Proceedings Reviewer: } SIGGRAPH 2016, SIGGRAPH Asia 2016, UIST 2016, NIPS 2016
