...
\begin{position}
I worked on and am credited in the short film ``Day and Night.'' I co-developed the film's pipeline for integrating 2D-animated characters into 3D scenes, and I also optimized the rendering of shots features hundreds of instances of desert vegetation. In addition, I wrote tools that allowed Pixar's in-house volumetric renderer to work with volumetric effects authored in Houdini.
\end{position}
